(function ()
{
    ...
    angular
        ...
        .controller( 'CarrierAdminConnectivityController', CarrierAdminConnectivityController );

    /** @ngInject */
    function CarrierAdminConnectivityController( $filter, histograms, meta, sensorHubs )
    {   
        var vm          = this;
